...
<body>	
	...
	<div id="body">
		<div id="about">
			...
			<center>
				<form method="get" action="listmakanan.php">
				<center>
			...
			<br><br>
			<h1 align="center"><b>DAFTAR MAKANAN UTAMA</b></h1>
			<br><br>
			<table border="1" align="center" bordercolor="#ffffff" cellspacing="0" cellpadding="5">
				...
				<?php
					...
					$result = mysql_query("SELECT b.nama_barang, b.harga, b.stok, b.gambar, b.keterangan, b.id_barang 
										   ...
										   WHERE b.id_jenis = j.id_jenis AND j.id_jenis =1 LIMIT $posisi, $batas");
					$no = $posisi+1;
				...
				echo"<tr bgcolor='#f682b1'>
					...
					<td align='center' width='150'>
						<a href=\"editmakanan.php?id=".$cols[5]."\"><button>Ubah</button></a>
						<a href=\"hapusmakanan.php?id=".$cols[5]."\" title=\"delete\" onclick=\"return confirm('Apakah Anda akan menghapus data ini?');\"><button>Hapus</button></a>
					</td>
				</tr>";
					$no++;	   
					}
					$tampil = mysql_query("SELECT b.nama_barang, b.harga, b.stok, b.gambar, b.keterangan 
										   FROM barang b, jenis j 
										   WHERE b.id_jenis = j.id_jenis AND j.id_jenis =1 GROUP BY b.nama_barang");
	...
	<div id="body">
		...
		<h3>
			...
			?>
				...
				<form method="get" action="listmakanan.php" align="right">
				<center>
					<input type="text" name="cari">
					<input type="submit" name="submit" value="Cari" class="button">
				</center>
		...
		<br><br>
			<table border="1" align="center" bordercolor="#ffffff" cellspacing="0" cellpadding="5" width="100%" height="100%">
				...
				<?php
					...
					$result = mysql_query("SELECT b.nama_barang, b.harga, b.stok, b.gambar, b.keterangan, b.id_barang 
										   FROM barang b, jenis j 
										   WHERE b.id_jenis = j.id_jenis AND j.id_jenis =1 AND nama_barang LIKE '%$cari%' LIMIT $posisi, $batas");
					$no = $posisi+1;
					while($cols = mysql_fetch_array($result))
					{
			...
			<br><br>
			<center><a href='listmakanan.php?&cari='><button>Kembali</button></center>
			</div>
		</div>
<?php }  
	include 'footer.php';
