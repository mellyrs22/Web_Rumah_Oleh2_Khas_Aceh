...
?>
	<div id="body">
		...
		<h3>
			...
			<center>
				<form method="get" action="listlainlain.php">
				<center>
			...
			<br><br>
			<h1 align="center"><b>DAFTAR LAIN-LAIN</b></h1>
			<br><br>
			<table border="1" align="center" bordercolor="#ffffff" cellspacing="0" cellpadding="5" width="100%" height="100%">
				...
				<?php
					...
					$result = mysql_query("SELECT b.nama_barang, b.harga, b.stok, b.gambar, b.keterangan, b.id_barang 
										   ...
										   WHERE b.id_jenis = j.id_jenis AND j.id_jenis =4 LIMIT $posisi, $batas");
					$no = $posisi+1;
				...
				echo"<tr bgcolor='#f682b1'>
					...
					<td align='center' width='150'>
						<a href=\"editlainlain.php?id=".$cols[5]."\"><button>Ubah</button></a>
						<a href=\"hapuslainlain.php?id=".$cols[5]."\" title=\"delete\" onclick=\"return confirm('Apakah Anda akan menghapus data ini?');\"><button>Hapus</button></a>
					</td>
				</tr>";
					$no++;	   
					}
					$tampil = mysql_query("SELECT b.nama_barang, b.harga, b.stok, b.gambar, b.keterangan 
										   FROM barang b, jenis j 
										   WHERE b.id_jenis = j.id_jenis AND j.id_jenis =4 GROUP BY b.nama_barang");
		...
		<h3>
			...
			<table border="1" align="center" bordercolor="#ffffff" cellspacing="0" cellpadding="5" width="100%" height="100%">
				...
				<?php
					...
					$result = mysql_query("SELECT b.nama_barang, b.harga, b.stok, b.gambar, b.keterangan, b.id_barang 
										   FROM barang b, jenis j 
										   WHERE b.id_jenis = j.id_jenis AND j.id_jenis =4 AND nama_barang LIKE '%$cari%' LIMIT $posisi, $batas");
					$no = $posisi+1;
					while($cols = mysql_fetch_array($result))
					{
